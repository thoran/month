# test/tc_Month_self.days_in_the_month.rb

class TC_Month_self_days_in_the_month < Minitest::Test
  ...
  def test_crap
    assert_nil Month.days_in_the_month('random')
    assert_nil Month.days_in_the_month(13)
  end
